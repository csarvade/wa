...
<title>Contact Us Page | Worldartx4U</title>
<script type="text/javascript">
	$(document).ready(function() {
		$('#productDtTable').DataTable();
...
<form action="#">
					...
					<div class="collapse navbar-collapse" id="navbarNavDropdown">
						<ul class="navbar-nav">
							...
							<li class="nav-item dropdown"><a
								class="btn btn-warning" href="login.jsp"  style="align: right;">
									SignUp </a>
						  </li>
	...
	<div class="container"><a href="images/white.jpg"><img src="images/white.jpg" width="1024" height="768" alt=""></a></div>
